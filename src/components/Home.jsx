...
const Home = () => {
    ...
    const roleUser = () => {
        ...
        switch (user.userRole) {
            // 문자열로 전달받는 값을 형변환해서 switch 문에 전달 예정(2/20)
