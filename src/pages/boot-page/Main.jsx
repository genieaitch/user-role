        ...
        <div className="container">
            <div className="row">
                <div className="col-8 text-center p-4 border rounded shadow">
                    ...
                    <p className="lead">이 컴포넌트는 Bootstrap 을 활용해서 스타일을 작성합니다.</p>
            ...
            <div className="row">
                <div className="col-4">
                    <div className="card">
                        <img src="https://cdn.autobild.es/sites/navi.axelspringer.es/public/media/image/2016/07/554539-ultimo-caca-cerdo-construir-carreteras.jpg?tf=3840xs" className="card-img-top"/>
